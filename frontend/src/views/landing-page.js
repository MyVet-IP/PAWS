export function loadLandingPage() {
    return `
<nav class="main-nav bg-white/80 border-b border-gray-200/50" style="position: sticky; top: 0; z-index: 999;">
...
<div class="hidden md:flex items-center gap-8">
                ...
                <a href="#/emergencias" class="text-gray-700 hover:text-purple-600 font-medium transition-colors">Emergencias</a>
...
<div class="w-10 h-10 rounded-full border-2 border-white" style="background: linear-gradient(135deg, #60a5fa 0%, #a78bfa 100%);"></div>
<div class="w-10 h-10 rounded-full border-2 border-white" style="background: linear-gradient(135deg, #f472b6 0%, #fb923c 100%);"></div>
<div class="w-10 h-10 rounded-full border-2 border-white" style="background: linear-gradient(135deg, #34d399 0%, #14b8a6 100%);"></div>
</div>
...
<div class="absolute top-8 right-8 bg-blue-100 rounded-2xl p-4 shadow-card max-w-xs">
<div class="flex items-start gap-3">
<div class="w-10 h-10 bg-blue-300 rounded-lg flex items-center justify-center flex-shrink-0">
...
<div class="absolute bottom-8 left-8 bg-pink-100 rounded-2xl p-4 shadow-card max-w-xs">
...
<a href="#" class="text-purple-400 hover:text-purple-500 font-medium flex items-center gap-1">
...
<img src="./frontend/assets/images/lllll.jpg" alt="Paws & Hearts Wellness" class="w-full h-full object-cover">
<span class="absolute top-4 right-4 bg-white text-gray-700 px-4 py-1 rounded-full text-xs font-semibold">Especialista</span>
</div>
<div class="p-6">
<div class="flex items-start justify-between mb-2">
<h3 class="text-xl font-bold text-gray-800">Paws & Hearts Wellness</h3>
...
<span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-lg text-xs font-medium">CIRUGÍA</span>
<span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-lg text-xs font-medium">RAYOS X</span>
<span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-lg text-xs font-medium">DENTAL</span>
</div>
</div>
</div>
...
<div class="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-xl transition">
<div class="relative h-64">
<img src="./frontend/assets/images/lllll.jpg" alt="Centro Médico Animal" class="w-full h-full object-cover">
<span class="absolute top-4 right-4 bg-pink-400 text-white px-4 py-1 rounded-full text-xs font-semibold">Urgencias 24/7</span>
</div>
<div class="p-6">
<div class="flex items-start justify-between mb-2">
<h3 class="text-xl font-bold text-gray-800">Centro Médico Animal</h3>
<div class="flex items-center gap-1">
<svg class="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
<path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
</svg>
...
<div class="flex gap-2 flex-wrap">
<span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-lg text-xs font-medium">CARDIOLOGÍA</span>
<span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-lg text-xs font-medium">VACUNAS</span>
</div>
</div>
</div>
...
<div class="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-xl transition">
<div class="relative h-64">
<img src="./frontend/assets/images/lllll.jpg" alt="San Francisco Hospital" class="w-full h-full object-cover">
</div>
<div class="p-6">
<div class="flex items-start justify-between mb-2">
<h3 class="text-xl font-bold text-gray-800">San Francisco Hospital</h3>
<div class="flex items-center gap-1">
<svg class="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
<path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
</svg>
...
<span>Condesa, Ciudad de México</span>
</div>
<div class="flex gap-2 flex-wrap">
<span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-lg text-xs font-medium">LABORATORIO</span>
<span class="bg-gray-100 text-gray-700 px-3 py-1 rounded-lg text-xs font-medium">FISIOTERAPIA</span>
</div>
</div>
></div>
</div>
...
<button class="bg-gray-800 text-white px-8 py-4 rounded-2xl font-medium hover:bg-gray-700 transition">Empieza hoy gratis</button>
...
<footer class="bg-gray-900 text-white pt-16 pb-8" style="margin-top: 80px;">
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
<p class="text-gray-300 text-sm mb-6" style="line-height: 1.6;">
La plataforma líder en búsqueda y gestión de salud para mascotas en Latinoamérica. Tu mascota, nuestra prioridad.
</p>
<div class="flex gap-3">
<a href="#twitter" class="w-10 h-10 bg-gray-800 hover:bg-purple-400 rounded-full flex items-center justify-center transition" aria-label="Twitter">
<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
<path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
</svg>
</a>
<a href="#instagram" class="w-10 h-10 bg-gray-800 hover:bg-purple-400 rounded-full flex items-center justify-center transition" aria-label="Instagram">
<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
Recibe consejos de salud semanales para tus mascotas.
</p>
<form>
<input type="email" 
       placeholder="tu@email.com" 
       class="w-full px-4 py-3 rounded-full bg-gray-800 border border-gray-700 text-white placeholder-gray-400 text-sm mb-3">
...
<p class="text-gray-400 text-sm">© 2024 VetCare. Todos los derechos reservados.</p>
