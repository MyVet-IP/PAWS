...
async function testConnection() {
  ...
  try {
    ...
    if (tables.length > 0) {
      ...
      console.log('   ⚠️  No se encontraron tablas. Ejecuta el schema SQL.');
    }
    console.log('');

    // Test 3: Verificar datos de ejemplo
    console.log('3️⃣  Probando lectura de datos...');
    ...
    // Test 4: Cerrar conexión
    console.log('4️⃣  Cerrando conexión...');
    await db.close();
